...
def get_prompt() -> ChatPromptTemplate:
    return ChatPromptTemplate.from_messages([
        ("system",
            ...
            "2. When user asks to SUMMARIZE — call list_emails or search_emails, then read_email, then show ONLY a clean 3-5 line summary. NEVER show full email content when summarizing. Summary must cover: who sent it, what it is about, what action is needed.\n"
